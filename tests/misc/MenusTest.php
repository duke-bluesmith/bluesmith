...
final class MenusTest extends ProjectTestCase
{
    ...
    public static function setUpBeforeClass(): void
    {
        ...
        self::$expectedManage = '<ul data-widget="treeview" role="menu" data-accordion="false" class="nav nav-pills nav-sidebar flex-column"><li class="nav-item"><a href="' . site_url('manage/dashboard') . '" class="nav-link"><i class="nav-icon fas fa-tachometer-alt"></i><p>Dashboard</p><span class="right badge badge-warning">0</span></a></li><li class="nav-item has-treeview menu-open"><a href="' . site_url('manage/jobs') . '" class="nav-link has-treeview"><i class="nav-icon fas fa-th-list"></i><p>Jobs<i class="right fas fa-angle-left"></i></p></a><ul class="nav nav-treeview"><li class="nav-item"><a href="' . site_url('manage/jobs/active') . '" class="nav-link"><i class="far fa-circle nav-icon"></i><p>Active Jobs</p></a></li><li class="nav-item"><a href="' . site_url('manage/jobs/archive') . '" class="nav-link"><i class="far fa-circle nav-icon"></i><p>Completed Jobs</p></a></li><li class="nav-item"><a href="' . site_url('manage/jobs/all') . '" class="nav-link"><i class="far fa-circle nav-icon"></i><p>All Jobs</p></a></li></ul></li><li class="nav-item has-treeview menu-open"><a href="' . site_url('manage/users') . '" class="nav-link has-treeview"><i class="nav-icon fas fa-user-friends"></i><p>Users<i class="right fas fa-angle-left"></i></p></a><ul class="nav nav-treeview"><li class="nav-item"><a href="' . site_url('manage/users/index') . '" class="nav-link"><i class="far fa-circle nav-icon"></i><p>All Users</p></a></li><li class="nav-item"><a href="' . site_url('manage/users/staff') . '" class="nav-link"><i class="far fa-circle nav-icon"></i><p>Staff</p></a></li></ul></li><li class="nav-item has-treeview"><a href="' . site_url('workflows') . '" class="nav-link has-treeview"><i class="nav-icon fas fa-project-diagram"></i><p>Workflows<i class="right fas fa-angle-left"></i></p></a><ul class="nav nav-treeview"><li class="nav-item"><a href="' . site_url('workflows') . '" class="nav-link"><i class="far fa-circle nav-icon"></i><p>Index</p></a></li><li class="nav-item"><a href="' . site_url('actions') . '" class="nav-link"><i class="far fa-circle nav-icon"></i><p>Actions</p></a></li></ul></li><li class="nav-header">CONTENT MANAGEMENT</li><li class="nav-item has-treeview"><a href="' . site_url('emails/templates') . '" class="nav-link has-treeview"><i class="nav-icon fas fa-inbox"></i><p>Email<i class="right fas fa-angle-left"></i></p></a><ul class="nav nav-treeview"><li class="nav-item"><a href="' . site_url('emails/templates') . '" class="nav-link"><i class="far fa-circle nav-icon"></i><p>List Templates</p></a></li><li class="nav-item"><a href="' . site_url('emails/templates/new') . '" class="nav-link"><i class="far fa-circle nav-icon"></i><p>Add Template</p></a></li></ul></li><li class="nav-item has-treeview"><a href="' . site_url('manage/content/page') . '" class="nav-link has-treeview"><i class="nav-icon fas fa-file-alt"></i><p>Pages<i class="right fas fa-angle-left"></i></p></a><ul class="nav nav-treeview"></ul></li><li class="nav-item"><a href="' . site_url('manage/methods') . '" class="nav-link"><i class="nav-icon fas fa-cubes"></i><p>Methods</p></a></li><li class="nav-item"><a href="' . site_url('manage/materials') . '" class="nav-link"><i class="nav-icon fas fa-tools"></i><p>Materials</p></a></li><li class="nav-item"><a href="' . site_url('manage/content/branding') . '" class="nav-link"><i class="nav-icon fas fa-copyright"></i><p>Branding</p></a></li></ul>';
    }
